...
public class TestCommunication {
    ...
    private static TestCommunication testCommunication = null;
    public synchronized static TestCommunication getInstance() {
        try {
    ...
    private class RunningTask implements Runnable {
        ...
        public void run() {
            try {
                ...
                synchronized (TestCommunication.class) {
